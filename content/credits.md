...
## Making and Knowing Project Managers, Assistants, and Interns
  ...
  ![grotto-making](/images/sp22_grotto-making.jpg)
...
<td valign=top>Javier Ardila Gutierrez (graduate) <br><br> Lily Bunger (undergraduate) <br><br> Roya Chu (graduate) <br><br> Zoe de Bretagne (undergraduate) <br><br> Sabina Diaz-Rimal (undergraduate) <br><br> Hannah Halberstam (undergraduate) <br><br> Kian Hosseinnia (graduate) <br><br> Gretchin Kepplinger (graduate) <br><br> Cerrina Lai (undergraduate) <br><br> Joshua Leonard (graduate) <br><br> Sheena McKeever (graduate) <br><br> Catherine Otachime (graduate) <br><br> Stephanie Reitzig (graduate) <br><br> Olivia Ruble (undergraduate) <br><br> Lucia Santos (undergraduate) <br><br> Mika Tal (graduate) <br><br></td>
<td valign=top>Blessing Bafunso (graduate) <br><br> Debaleena Bagchi (graduate) <br><br> Alice Bai (undergraduate) <br><br> Yusef Bhimani (undergraduate) <br><br> Xin Gao (graduate) <br><br> Sophie Kerwin (graduate) <br><br> Chinmay Kumar (undergraduate) <br><br> Wanpanxin Liu (graduate) <br><br> Madeleine Luckel (graduate) <br><br> Melody Luo (undergraduate) <br><br> Jacob Price (graduate) <br><br> Emma Riddle (graduate) <br><br> Amy Stulman (undergraduate) <br><br> Helen Sullivan (graduate) <br><br> Vane Weingrad (undergraduate) <br><br> Rachel Yuan (undergraduate) <br><br></td>
</tr>
</tbody>
</table>
