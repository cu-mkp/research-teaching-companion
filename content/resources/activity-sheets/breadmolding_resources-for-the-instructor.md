...
Can be done almost anywhere (if only using wax for pour)

If in ventilated space (lab/studio/outdoors) can use sulfur
...
[Powerpoint presentation showing the process](/documents/activity-sheets/breadmoldingreconstruction_visual presentation of part2_casting.pdf)
...
We recommend you start class with a group discussion about each
student’s experience baking bread and exploring recipes for bread.
...
#### Discussion: breadmolding, bread as a material in the workshop
